...
/// not homogeneous and nessary part of the same data demension. It just happens
...
class Sensor {
  ...
  void _process(detection) {
    ...
    if (sensorSignal.containsValue(null)) {
      ...
      sensorSignal[SensorSignal.rate] = _emmissionCounter /
          _sensorStarted.difference(new DateTime.now()).inMilliseconds;
